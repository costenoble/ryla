 ...
 * l'esthétique, mais rien dans le produit ne le limite à ces deux-là : le
 * dire fermerait la porte aux kinés, ORL et chirurgiens qu'on visera ensuite,
 * et obligerait à réécrire cette page à chaque ouverture.
 *
        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
          <FadeUp>
            ...
            <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-muted">
              <p>
                Pas de connecteur à faire installer, pas de projet informatique, pas de
                technicien à faire venir. Ryla vit à côté de votre logiciel, pas dedans.
              </p>
              <p>
          ...
          <FadeUp delay={0.08}>
            <ol className="space-y-3">
              {[
                ["Vous créez le document", "Depuis la bibliothèque, ou votre propre devis importé."],
                ["Le patient reçoit un lien", "Il remplit et signe depuis son téléphone."],
                ["Vous téléchargez le PDF", "Et vous le classez où vous avez l'habitude."],
              ].map(([title, detail], index) => (
                <li
                  key={title}
                  className="flex items-start gap-4 rounded-2xl border border-line bg-surface p-4 shadow-tile"
                >
            ...
            <FadeUp delay={0.08}>
              ...
              <div className="mt-5 space-y-4 text-[15px] leading-relaxed text-muted">
                ...
                <p>
                  ...
                  votre patient, vous ne présentez pas un paraphe au bas d'une page :
                  vous présentez ce qu'il a lu, et combien de temps.
                </p>
              </div>
            </FadeUp>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 sm:px-6">
        ...
        <Stagger className="mt-8 grid gap-4 sm:grid-cols-3">
          {[
            ...
            <StaggerItem key={title}>
              <div className="h-full rounded-2xl border border-line bg-surface p-5 shadow-tile">
                <span className="mb-3 flex size-9 items-center justify-center rounded-xl bg-brand-50 text-brand-600">
